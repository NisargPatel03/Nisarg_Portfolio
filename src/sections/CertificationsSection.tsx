          ...
          <AnimatePresence mode="popLayout">
            {filteredCerts.map((cert) => (
              <motion.div
                ...
                key={cert.title}
                className="cert-card cyber-light-border bg-[#121212] border border-[#232323] hover:border-[#B600A8]/30 rounded-3xl p-6 flex flex-col justify-between gap-5 transition-all duration-300 group hover:shadow-[0_10px_25px_rgba(182,0,168,0.06)] relative h-full"
              >
