            ...
            >
              ...
              >
                {isEven ? (
                  ...
                  >
                    <div className="timeline-card cyber-light-border bg-gradient-to-br from-blue-950/40 to-slate-950/70 border border-blue-900/30 hover:border-[#B600A8]/40 transition-colors p-6 rounded-3xl relative group shadow-[0_15px_35px_rgba(0,0,0,0.5)]">
              ...
              >
                {isEven ? (
                  ...
                  <motion.div
                    ...
                    className="w-full"
                  >
                    <div className="timeline-card cyber-light-border bg-gradient-to-br from-blue-950/40 to-slate-950/70 border border-blue-900/30 hover:border-[#7621B0]/40 transition-colors p-6 rounded-3xl relative group shadow-[0_15px_35px_rgba(0,0,0,0.5)]">
                      {/* Arrow pointer targeting the center line */}
