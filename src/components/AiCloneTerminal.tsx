      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            data-lenis-prevent
            className={`fixed bottom-36 right-6 z-[45] w-[90vw] max-w-md border rounded-xl flex flex-col overflow-hidden backdrop-blur-md bg-black/90 font-mono ${shadowClass}`}
          >
            {/* Header section */}
